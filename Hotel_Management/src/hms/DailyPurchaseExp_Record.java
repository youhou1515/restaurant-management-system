...
public class DailyPurchaseExp_Record extends JFrame {
	...
	public DailyPurchaseExp_Record() {
...
//					JOptionPane.showMessageDialog(null, item);
							...
							dbcon.dailyotherexp_delete(sno);
...
//						model.setRowCount(0);
		...
		lblSearch.setIcon(new ImageIcon(DailyPurchaseExp_Record.class.getResource("/hms/images/Zoom-icon2.png")));
		lblSearch.setFont(new Font("Calibri", Font.PLAIN, 15));
		lblSearch.setBounds(10, 96, 1142, 56);
		contentPanel.add(lblSearch);

		JLabel lblShowAllVehicle = new JLabel("Daily Purchase Record");
		...
		lblTotal.setBounds(797, 678, 45, 31);
		contentPanel.add(lblTotal);

		lblNewLabel = new JLabel("0");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel.setBounds(854, 686, 142, 14);
	...
	public void datequery(String data13, String data14) throws SQLException {
		try {
			...
			String sql = "Select sno as S_No, purpose as Purpose,amount as Amount, enteredby as Entered_By, entereddate as Entry_Date from dailyotherexpenses where entereddate between '"
					+ data13 + "' and '" + data14 + "'";
...
//	JOptionPane.showMessageDialog(null, nRow);
		...
		for (int i = 0; i < nRow; i++) {
			...
			double amount = Double.parseDouble(model2.getValueAt(i, 2).toString());
