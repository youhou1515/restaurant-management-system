...
public class advancebookinglist extends JFrame {
...
//		table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		...
		lblSearch.setIcon(new ImageIcon(advancebookinglist.class.getResource("/hms/images/Zoom-icon.png")));
		lblSearch.setFont(new Font("Calibri", Font.PLAIN, 15));
		lblSearch.setBounds(125, 108, 59, 56);
		contentPanel.add(lblSearch);

		JLabel lblShowAllVehicle = new JLabel("Advance Booking List");
...
//		JOptionPane.showMessageDialog(null,time);
		dbcon.connect();
		String sql = "Select bookingocassion,customername,address,aadharno,mobile,datefrom,dateto,timeto,timefrom,totalcost,remainingamount from bookingdetails WHERE datefrom='"+time+"'";
		dbcon.pst = dbcon.conn.prepareStatement(sql);
		dbcon.rs = dbcon.pst.executeQuery();
