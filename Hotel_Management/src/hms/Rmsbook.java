...
public class Rmsbook extends JFrame implements ActionListener {
	...
	public Rmsbook(String current_user) throws SQLException {
		...
		// setBounds(0, 0, dim.width * 18 / 20, dim.height * 19 / 20);
		...
		// Dimension maxSize = new Dimension(minRequiredWidth,
		// minRequiredHeight);
		// for (int i = 0; i < gs.length; i++)
		// {
		// DisplayMode dm = gs[i].getDisplayMode();
		// if (dm.getWidth() > maxSize.getWidth() && dm.getHeight() >
		// maxSize.getHeight())
		...
		JLabel lblNewLabel_2 = new JLabel("RESTAURANT ORDER PANEL");
		...
		panel_8.setBounds(17, 527, 913, 125);
		...
		scrollPane_1.setBounds(0, 0, 915, 125);
		...
		table_1.getColumnModel().getColumn(0).setMinWidth(109);
		table_1.getColumnModel().getColumn(1).setPreferredWidth(76);
		table_1.getColumnModel().getColumn(2).setPreferredWidth(106);
		table_1.getColumnModel().getColumn(2).setMinWidth(106);
		table_1.getColumnModel().getColumn(3).setPreferredWidth(47);
		table_1.getColumnModel().getColumn(3).setMinWidth(47);
		table_1.getColumnModel().getColumn(4).setPreferredWidth(120);
		table_1.getColumnModel().getColumn(4).setMinWidth(120);
		table_1.getColumnModel().getColumn(5).setPreferredWidth(55);
		table_1.getColumnModel().getColumn(5).setMinWidth(55);
		table_1.getColumnModel().getColumn(6).setPreferredWidth(79);
		table_1.getColumnModel().getColumn(8).setPreferredWidth(61);
		table_1.getColumnModel().getColumn(8).setMinWidth(61);
		table_1.getColumnModel().getColumn(9).setPreferredWidth(108);
		table_1.getColumnModel().getColumn(9).setMinWidth(108);
		...
		table_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					String tablenameupdate1 = model.getValueAt(selectedRowIndex, 0).toString();
					billfinalsave = model.getValueAt(selectedRowIndex, 1).toString();
					label_13.setText(billfinalsave.substring(8));

					dbcon.updateItemtoY(billfinalsave);
					...
					if (tablenameupdate1.equals("PARCEL") || tablenameupdate1.equals("HOME DELIVERY")) {

					} else {

						ComboBoxModel combomodel = comboBox_1.getModel();
						int size = combomodel.getSize();
						for (int i = 0; i < size; i++) {
							Object element = combomodel.getElementAt(i);

							if (element.equals(tablenameupdate1)) {
								result1 = true;
							}
						}
...

					{
						...
						comboBox_1.addItem(tablenameupdate1);
					}

					comboBox_1.setSelectedItem(model.getValueAt(selectedRowIndex, 0));
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					if (table.getRowCount() > 0) {
						...
						String itemname1 = itemname.concat("->");

						try {
							comments = model.getValueAt(SelectedRowIndex, 5).toString();
						} catch (Exception f) {
							comments = "";
						}
						...
						try {
							dbcon.delete_billitemwise(itemname1, billmerge);
						} catch (Exception f) {
		...
		table.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Sl No.", "Items", "Unit Price", "Quantity", "Total Amount", "Comments", "status" }));
		...
		textField_1.getEditor().getEditorComponent().addFocusListener(new FocusAdapter() {
			public void focusLost(FocusEvent e) {
				boolean result = Regex_alphanumeric(textField_1.getSelectedItem().toString());
				if (result != true) {
		...
		// textField_1.getEditor().getEditorComponent().addKeyListener(new
		// KeyAdapter() {
		//
		// public void focusLost(FocusEvent arg0) {
		// boolean result =
		// Regex_alphanumeric(textField_1.getSelectedItem().toString());
		// if (result != true) {
		// JOptionPane.showMessageDialog(null, "Please Enter Alphanumeric
		// only");
		// textField_1.setSelectedItem(null);
		//
		// }
		...
		comboBox_2.setBounds(10, 20, 307, 30);
		panel_4.add(comboBox_2);

		JButton btnNewButton_3 = new JButton("");
		btnNewButton_3.setIcon(new ImageIcon(Rmsbook.class.getResource("/hms/images/refresh.png")));
		...
		btnNewButton_3.setBounds(319, 20, 29, 30);
		...
		lblUserName.setBounds(0, 0, 1424, 21);
		...
		label_3.setBounds(122, 0, 181, 158);
		panel.add(label_3);
		showcompanydetails();
		...
		panel_5.setBounds(1052, 336, 298, 257);
		contentPanel.add(panel_5);

		label_8 = new JLabel("0.0");
		label_8.setHorizontalAlignment(SwingConstants.RIGHT);
		label_8.setBackground(Color.WHITE);
		label_8.setBounds(140, 177, 90, 20);
		panel_5.add(label_8);

		label_7 = new JLabel("0.0");
		label_7.setHorizontalAlignment(SwingConstants.RIGHT);
		label_7.setBackground(Color.WHITE);
		label_7.setBounds(140, 162, 90, 20);
		panel_5.add(label_7);
		...
		textField_2.setBounds(140, 202, 90, 33);
		...
		label_1.setBounds(227, 125, 22, 14);
		panel_5.add(label_1);
		...
		comboBox_3.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				try {
					...
					Double subtotal = 0.0;
					try {
						subtotal = Double.valueOf(textField_4.getText());
		...
		ShowTax();
		comboBox_3.setBounds(140, 122, 90, 20);
		panel_5.add(comboBox_3);

		textField_4 = new JTextField("0");
		textField_4.setBounds(142, 11, 103, 20);
		...
		button_2.setIcon(new ImageIcon(Rmsbook.class.getResource("/hms/images/refresh16by16.png")));
		button_2.setBounds(42, 122, 18, 20);
		...
		textField_13.setBounds(991, 26, 359, 36);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (comboBox_2.getSelectedItem() == null || comboBox_2.getSelectedItem().equals("SELECT")) {
						...
						// customer_name =
						// textField_1.getSelectedItem().toString().toUpperCase();
						try {
						...
						// bill merger number + INVOICE/
						String billmerge = "INVOICE/".concat(bill);
						// kotid merger number + KOT/
						String Kot_idmerge = "KOTID/".concat(Kot_id);
						savedate = nowdate();
						dbcon.connect();

						for (int i = 0; i < nRow; i++) {
							String sql1 = "Insert into bill_list(kotid, bill_no,item_name,unit_price,quantity,amount,status,entrydate) VALUES('"
									+ Kot_idmerge + "','" + billmerge + "','"
									+ tableData[i][1].concat("->" + tableData[i][5].toUpperCase()) + "','"
									+ tableData[i][2] + "','" + tableData[i][3] + "','" + tableData[i][4] + "','"
									+ tableData[i][6] + "','" + savedate + "')";
						...
						Object[] row = { tablename, billmerge, koitdmerge, customerwishes, customer_name, occasion_date,
						...
						printfunction4kot(tablename, koitdmerge, savetime, savedate, waiter_name, nRow, billmerge);
					...
					JOptionPane.showMessageDialog(null, e1 + ":-<err Reserve a table");
				}
				// clearall();
		...
		panel_9.setBounds(952, 64, 398, 148);
		contentPanel.add(panel_9);
		panel_9.setLayout(null);

		JScrollPane scrollPane_2 = new JScrollPane();
		scrollPane_2.setBounds(0, 0, 398, 148);
		...
		label_5.setBounds(940, 475, 95, 145);
		...
		btnNewButton.setBounds(1074, 604, 112, 41);
					...
					if (models.getRowCount() > 0) {
						if (table_1.getSelectionModel().isSelectionEmpty()) {
							...
							JOptionPane.showMessageDialog(null,
								...
								|| comboBox_3.getSelectedItem().equals("SELECT")) {
							...
							if (reply == JOptionPane.YES_OPTION) {
								...
								SelectedRowIndex = table_1.getSelectedRow();
								billprint = models.getValueAt(SelectedRowIndex, 1).toString();
								...
								dbcon.cust_detailentry(billprint, customer_name, cust_mob, customerwishes,
										occasion_date, waiter_name, datebill, savetime, subtotaltype, cgsttype,
										sgsttype, discounttype, grandtotaltype, lblNewLabel_4.getText().substring(21),
										paymentmode);
								...
								for (int i = 0; i < nRow; i++) {
									...
									String sql1 = "Insert into tablecustomerdetail_itemlist VALUES('" + billprint
											...
											+ tableDatanew[i][2] + "','" + tableDatanew[i][3] + "','"
											+ tableDatanew[i][4] + "','" + lblNewLabel_4.getText().substring(21) + "')";
								...
								boolean result1 = false;
								if (tablenumber_addafter_bill_paid.equals("PARCEL")
										|| tablenumber_addafter_bill_paid.equals("HOME DELIVERY")) {
									...
									for (int i = 0; i < size; i++) {
										...
										if (element.equals(tablenumber_addafter_bill_paid)) {
											result1 = true;
										}
									}
								...
								// JOptionPane.showMessageDialog(null,
								// tablenumber_addafter_bill_paid);
						...
						JOptionPane.showMessageDialog(null, "No Bill/Selected to Pay");
					}
		...
		btnNewBill = new JButton("<html>New <br> [Alt+N]</html>");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (reply == JOptionPane.YES_OPTION) {
						...
						// DefaultTableModel modelclear = (DefaultTableModel)
						// table_1.getModel();
		...
		btnNewBill.setBounds(1215, 604, 112, 41);
		contentPanel.add(btnNewBill);

		btnNewButton_2 = new JButton("<html>UPDATE BILL<br> &nbsp &nbsp[ Alt &nbsp + &nbsp U ]</html>");
		btnNewButton_2.setMnemonic('U');
		btnNewButton_2.setMnemonic(KeyEvent.VK_U);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (int i = 0; i < nRow; i++) {
						...
						String sql1 = "Insert into bill_list(bill_no,item_name,unit_price,quantity,amount,kotid,status) VALUES('"
								+ billmerge + "','" + tableData[i][1] + "','" + tableData[i][2] + "','"
								+ tableData[i][3] + "','" + tableData[i][4] + "','" + Kot_id + "','" + tableData[i][6]
								+ "')";
					...
					model.setRowCount(0);
					Object[] row = { tablename, billmerge, Kot_id, customerwishes, customer_name, occasion_date,
							cust_mob, listamount, savetime, savedate, waiter };
					model = (DefaultTableModel) table_1.getModel();

					model.addRow(row);
					// JOptionPane.showMessageDialog(null, "UPDATED");
					printfunction4kot(tablename, Kot_id, savetime, savedate, waiter, nRow, billmerge);
					...
					if (tablename.equals("PARCEL") || tablename.equals("HOME DELIVERY")) {

					} else {

						comboBox_1.removeItem(tablename);
					}
		...
		btnCancelATable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					DefaultTableModel model12 = (DefaultTableModel) table_1.getModel();
					if (model12.getRowCount() > 0) {
						int selectedRowIndex = 0;
						selectedRowIndex = table_1.getSelectedRow();
						...
						if (selectedRowIndex < 0) {
							...
							boolean result1 = false;
							if (TableClick.equals("PARCEL") || TableClick.equals("HOME DELIVERY")) {
							...
							int SelectedRowIndex = table_1.getSelectedRow();
							model12.removeRow(SelectedRowIndex);
							clearall();
							set_max_function();
							set_max_function_for_KOTID();
						}
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (comboBox.getSelectedItem() == null || comboBox.getSelectedItem().equals("SELECT")) {
						...
						Object[] row = { serialno, itemname, unitprice, quantity, totalamount, Comments, status };
	...
	//
	// dbcon.connect();
	// String sql = "Select item_name,unit_price,quantity,amount from bill_list
	// where bill_no='" + finalsave + "'";
	// dbcon.pst = dbcon.conn.prepareStatement(sql);
	// dbcon.rs = dbcon.pst.executeQuery();
	// int i = 1;
	//
	...
	public void showtheitem(String finalsave) throws SQLException {
		try {
			...
			dbcon.connect();
			String sql = "Select item_name,unit_price,quantity,amount,status from bill_list where bill_no='" + finalsave
					+ "'";
			dbcon.pst = dbcon.conn.prepareStatement(sql);
			dbcon.rs = dbcon.pst.executeQuery();
			int i = 1;
			while (dbcon.rs.next()) {
				...
				String quantity = dbcon.rs.getString("quantity");
				String amount = dbcon.rs.getString("amount");
				String status = dbcon.rs.getString("status");

				Object[] row = { i, item_namesplit[0], unit_price, quantity, amount, "", status };
	...
	public void showcompanydetails() throws SQLException {
		try {
			...
			dbcon.connect();
			String sql = "Select companyimage from companyprofile";
			dbcon.pst = dbcon.conn.prepareStatement(sql);
			dbcon.rs = dbcon.pst.executeQuery();
			while (dbcon.rs.next()) {
				...
				//
				BufferedImage newimage = resizeImage(bImage2, 180, 136);
				//
...
//			 hashmap.putAll(getBranchDetails());
			...
			hashmap.put("companyaddress", (companyaddress == null ? "" : companyaddress));
			hashmap.put("companyname", (companyname == null ? "" : companyname));
			hashmap.put("companygstin", (companygstin == null ? "" : companygstin));
			hashmap.put("companymobile", (companymobile == null ? "" : companymobile));
			hashmap.put("companycity", (companycity == null ? "" : companycity));
			...
			JasperPrint jp = JasperFillManager.fillReport(jr, hashmap, dbcon.conn);
	...
	public void printfunction4kot(String tableno, String kotnumber, String savetime, String savedate,
		...
		try {
			...
			// JasperDesign jd =
			// JRXmlLoader.load("D:\\workspace\\Hotel_Management\\src\\restkot.jrxml");
			String sql = "select * from bill_list WHERE bill_no='" + bl + "' and status='N'";
			JRDesignQuery newquery = new JRDesignQuery();
			newquery.setText(sql);
			jd.setQuery(newquery);
