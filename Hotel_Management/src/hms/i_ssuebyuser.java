...
public class i_ssuebyuser extends JFrame {
...
//		contentPanel.setBackground(Color.LIGHT_GRAY);
		...
		label_6.setBounds(34, 159, 102, 26);
		panel.add(label_6);
...
//				
//		});
		comboBox_2.setBounds(147, 161, 335, 26);
...
//						JOptionPane.showMessageDialog(null, "3");
						...
						if (verify == true) {
							...
							Object[] row = { issuestocknum, comboBox_2.getSelectedItem().toString(),
									...
									textField_5.getSelectedItem(), textField_6.getSelectedItem() };
							model.addRow(row);
		...
		JLabel label_13 = new JLabel("Note: Select product and Press Enter to see available stock.");
		label_13.setBounds(155, 187, 328, 14);
		panel.add(label_13);

		JPanel panel_1 = new JPanel();
		panel_1.setBounds(543, 68, 548, 656);
		contentPanel.add(panel_1);
		panel_1.setLayout(null);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(0, 0, 548, 656);
...
//		});
		...
		table.getColumnModel().getColumn(4).setMinWidth(111);
		table.getColumnModel().getColumn(5).setPreferredWidth(112);
		table.getColumnModel().getColumn(5).setMinWidth(112);
		scrollPane.setViewportView(table);
		
		JLabel label_12 = new JLabel("STOCK ISSUE");
		label_12.setOpaque(true);
		label_12.setHorizontalAlignment(SwingConstants.CENTER);
		label_12.setForeground(Color.BLACK);
		label_12.setFont(new Font("Calibri", Font.PLAIN, 18));
		label_12.setBackground(Color.WHITE);
		label_12.setBounds(0, 0, 1089, 31);
