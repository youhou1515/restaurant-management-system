...
public class showpurchaserecord_admin extends JFrame {
	...
	public showpurchaserecord_admin() {
...
//		contentPanel.setBackground(Color.LIGHT_GRAY);
		...
		lblSearch.setIcon(new ImageIcon(showpurchaserecord_admin.class.getResource("/hms/images/Zoom-icon.png")));
		...
		table.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				try {
					...
					int nColumn = model2.getColumnCount();

//					LinkedList productname = new LinkedList();
//					LinkedList quantity = new LinkedList();
//					productname.add(model2.getValueAt(i, 1));
//					quantity.add(model2.getValueAt(i, 2));
					
					
					String[][] tablelist = new String[nRow][nColumn];
					...
					for (int i = 0; i < nRow; i++) {
						...
						tablelist[i][j] = model2.getValueAt(i, 1).toString();
						j++;
						tablelist[i][j] = model2.getValueAt(i, 2).toString();

//						JOptionPane.showMessageDialog(null, tablelist[i][0]);
//						JOptionPane.showMessageDialog(null, tablelist[i][1]);
					}
...
//						JOptionPane.showMessageDialog(null, item);
							...
							dbcon.stockup_addifdeletedarray(tablelist,nRow,nColumn,model2);
							
							
//							dbcon.purchaserecord_stockdelete();
