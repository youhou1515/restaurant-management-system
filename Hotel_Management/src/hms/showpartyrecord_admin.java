...
public class showpartyrecord_admin extends JFrame {
...
//		table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		...
		lblSearch.setIcon(new ImageIcon(showpartyrecord_admin.class.getResource("/hms/images/Zoom-icon.png")));
	...
	public void Table2() throws Exception {
		try {
			dbcon.connect();
			String sql = "Select * from party_details";
			dbcon.pst = dbcon.conn.prepareStatement(sql);
			dbcon.rs = dbcon.pst.executeQuery();
			table.setModel(DbUtils.resultSetToTableModel(dbcon.rs));
