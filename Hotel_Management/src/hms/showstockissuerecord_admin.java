...
public class showstockissuerecord_admin extends JFrame {
...
//	Strin data
	...
	public showstockissuerecord_admin() {
...
//		contentPanel.setBackground(Color.LIGHT_GRAY);
		...
		panel.setBounds(0, 150, 1047, 461);
		contentPanel.add(panel);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(0, 0, 1047, 461);
...
//					int SelectedRowIndex = table.getSelectedRow();
					...
					String issuedqtyreverse_add = model1.getValueAt(x, 5).toString();
					String issuedqtyreverse_add_where_productname = model1.getValueAt(x, 3).toString();
...
//		});
		...
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Bill Number", "Customer ID", "Name",
				"Aadhar No.", "Mobile No.", "New column", "New column", "New column", "New column", "New column" }) {
...
//		table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		...
		textField.setBounds(70, 110, 977, 31);
		contentPanel.add(textField);

		JLabel lblSearch = new JLabel("");
		lblSearch.setIcon(new ImageIcon(showstockissuerecord_admin.class.getResource("/hms/images/Zoom-icon2.png")));
		...
		lblShowAllVehicle.setBounds(0, 0, 1048, 31);
...
//		dateChooser_2.setMinSelectableDate(new Date());
		dateChooser.setBounds(684, 42, 157, 20);
...
//		dateChooser_3.setMinSelectableDate(new Date());
		...
		button.setBounds(684, 68, 366, 31);
		...
		lblTotalAmount.setBounds(893, 622, 46, 14);
		...
		lblCgstsgst.setBounds(487, 622, 35, 14);
...
//
//			dbcon.connect();
//			String sql = "Select * from tablecustomerdetail where savedate between '" + data13 + "' and '" + data14
//					+ "'";
