...
public class tablemaster extends JFrame {
...
//		contentPanel.setBackground(Color.LIGHT_GRAY);
		...
		JLabel lblAdddeleteTable = new JLabel("Add/Delete Table");
...
//							ShowTab_Table();
		...
		label.setIcon(new ImageIcon(tablemaster.class.getResource("/hms/images/tablelabel2.jpg")));
		label.setBounds(465, 446, 215, 177);
	...
	public void ShowTable() throws SQLException {
		try {
			...
			ResultSet rs = st.executeQuery("Select tablename from tablelist order by tablename asc");
			while (rs.next()) {
	...
	public void ShowTab_Table() throws SQLException {
		try {
			...
			dbcon.connect();
			String sql = "Select tablename from tablelist order by tablename asc";
